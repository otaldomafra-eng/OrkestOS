...
const Painel = () => {
  ...
  const insightCards = [
    ...
    },
    {
      ...
      detail: `${habits.filter(habit => habit.completed).length}/${habits.length || 0} h·bitos concluÌdos`,
  ...
  const handleEditProfile = async (e) => {
    ...
    // If nothing changed ‚Üí don't call API
